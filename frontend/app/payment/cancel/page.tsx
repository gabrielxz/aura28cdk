        ...
        <CardContent className="space-y-6">
          ...
          <div className="rounded-lg border bg-muted/50 p-4">
            <p className="text-sm text-muted-foreground">
              You can return to your dashboard or try purchasing again when you&apos;re ready. Your
              Soul Blueprint reading will be generated immediately after successful payment.
            </p>
          </div>

          {/* Benefits Reminder */}
          <div className="space-y-3">
            <h3 className="font-medium">What you&apos;ll get with your Soul Blueprint:</h3>
